...
export default function AddItems() {
  ...
  return (
    <>
      <h1 className="text-center text-2xl font-bold mt-5">Add Item to Auction</h1>
      <div className="flex flex-row justify-center ">
        <form className="flex flex-col mt-7 md:w-1/2" onSubmit={addItems}>
          ...
          />
          <label className="pt-2" htmlFor="seller">
            Seller's Name
          </label>
          <input
            type="text"
          ...
          />
          <label className="pt-2" htmlFor="desc">
            Item Description
          </label>
          <textarea
            type="text"
          ...
          />
          <label className="pt-2" htmlFor="minbid">
            Minimum Bid
          </label>
          <input
            type="text"
